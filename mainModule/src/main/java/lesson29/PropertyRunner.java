...
public class PropertyRunner {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext appContext = SpringApplication.run(PropertyRunner.class, args);
        PropertyService propertyService = appContext.getBean(PropertyService.class);
        propertyService.printProperties();

        LocalizationService localizationService = appContext.getBean(LocalizationService.class);
