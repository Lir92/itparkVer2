...
public class GenrePageController {
    ...
    public String index(Model model,
                        ...
                        @Positive @RequestParam(required = false, defaultValue = "5") Integer size) { // кол-во данных, которые будут отображаться, здесь 5 записей
                        // @Positive - проверяет на то является ли число отрицательным, НО она не учитывает 0.
//        if (page < 0 || size <= 0) {
