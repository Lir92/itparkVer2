...
public class Lecture41ReactiveProgramming {
    ...
    Фреймворк Netty основан на Jetty и используется не только для взаимодействия HTTP Client-Server, но и для других сетевых
    ...
    Для работы с реактивными приложениями подходят NoSQL БД, в частности Mongo и Redis, Casandra, PosgreSQL.
    ...
    Flux - аналог stream api;
    Mono - аналог Optional в Java.
