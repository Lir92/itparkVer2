...
public class TokenAuthenticationFilter extends OncePerRequestFilter /* расширение, которое заставляет сработать каждый раз при запросе*/ {
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        chain.doFilter(request, response); // обязательный вызов, для работы фильтра
    }

    public Optional<String> getTokenIfPresent(HttpServletRequest request) { // запрос на наличие токена
