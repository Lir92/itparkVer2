...
public class ExecutorRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        executorService.invokeAll(List.of(new PrinterCallable("Hello world again!")));
        ...
        while (!summa.isDone()) {
            Thread.sleep(10);
            System.out.println("Ждём подсчётов");
        }
...
//        executorService.submit(() -> System.out.println("Привет мир!"));
//        executorService.shutdown(); // shutdown - завершает программу по завершению потоков, shutdownNow - завершает программу и все
        // потоки принудительно, не дожидаясь окончания работы потоков.
